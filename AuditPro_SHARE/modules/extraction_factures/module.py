    ...
    def execute(self, inputs, output_dir, progress_callback=None):
        ...
        try:
            ...
            if not ocr_available:
                logging.info("OCR indisponible: traitement PDF natifs uniquement")
            ...
            for i, pdf in enumerate(pdf_files):
                try:
                    ...
                    if invoices:
                        ...
                        if ocr_available:
                            logging.info("OCR actif: tentative sur PDFs scannés gérée par le script")
                        else:
                            logging.info("OCR indisponible: PDF scannés peuvent ne pas être lisibles")
